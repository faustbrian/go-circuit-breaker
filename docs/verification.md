...
The nested consumer-integration test module pins `go-jsonrpc` without adding it
...
`go-jsonrpc` integration suites keep protocol policy outside core. The latter
...
The 2026-07-16 downstream acceptance run used the concrete `go-http-client`
