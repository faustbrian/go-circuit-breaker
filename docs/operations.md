...
**Why did completion not update metrics?** The permit may belong to a stale
generation, disabled mode, or may already be terminal.

**Does `Close` disable the breaker?** No. It only drains the async observer.
