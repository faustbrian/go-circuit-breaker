...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-circuit-breaker" &&
                "${module_path}" != github.com/faustbrian/go-circuit-breaker/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-circuit-breaker"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
